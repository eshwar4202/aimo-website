      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap items-stretch max-w-5xl mx-auto">
          {data.plans.map((plan: Plan) => (
            ...
            >
              <div
                className={`flex flex-col p-6 space-y-6 rounded shadow-sm sm:p-8 min-h-[475px] min-w-[300px] transform transition-all duration-300 ease-in-out hover:z-10 hover:scale-105 hover:shadow-xl ${
