...
export interface SharedRichAbout extends Schema.Component {
  collectionName: 'components_shared_rich_abouts';
  info: {
    displayName: 'Rich about';
    description: '';
  };
  attributes: {
    body: Attribute.RichText;
...
export interface SectionsMember extends Schema.Component {
  collectionName: 'components_sections_members';
  info: {
    displayName: 'Member Rich';
    description: '';
  };
  attributes: {
    body: Attribute.RichText;
...
export interface SectionsMemberList extends Schema.Component {
  collectionName: 'components_sections_member_lists';
  info: {
...
export interface SectionsFlipbook extends Schema.Component {
  collectionName: 'components_sections_flipbooks';
  info: {
...
export interface SectionsFeeTable extends Schema.Component {
  collectionName: 'components_sections_fee_tables';
  info: {
    displayName: 'Fee table';
  };
  attributes: {
...
export interface SectionsContactPage extends Schema.Component {
  collectionName: 'components_sections_contact_pages';
  info: {
...
export interface SectionsAward extends Schema.Component {
...
export interface SectionsAboutAbout extends Schema.Component {
  collectionName: 'components_sections_about_abouts';
  info: {
    displayName: 'About About';
  };
  attributes: {
    location: Attribute.Text;
    structure: Attribute.Text;
    operation: Attribute.Text;
    tnsb: Attribute.Text;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'shared.rich-about': SharedRichAbout;
      ...
      'sections.member': SectionsMember;
      'sections.member-list': SectionsMemberList;
      ...
      'sections.flipbook': SectionsFlipbook;
      'sections.fee-table': SectionsFeeTable;
      'sections.features': SectionsFeatures;
      'sections.feature-rows-group': SectionsFeatureRowsGroup;
      'sections.feature-columns-group': SectionsFeatureColumnsGroup;
      'sections.contact-page': SectionsContactPage;
      'sections.bottom-actions': SectionsBottomActions;
      'sections.award': SectionsAward;
      'sections.about-hero': SectionsAboutHero;
      'sections.about-about': SectionsAboutAbout;
